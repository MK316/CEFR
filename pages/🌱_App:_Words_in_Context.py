...
def main():
    ...
    st.caption("Improve your vocabulary comprehension and pronunciation skills by listening to words used in context across various levels. Level B (1-725), Level C(1-1383)")
